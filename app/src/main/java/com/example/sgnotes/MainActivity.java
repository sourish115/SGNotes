...
import com.example.sgnotes.authorization.Login;
import com.example.sgnotes.authorization.Register;
import com.example.sgnotes.notes.AddNotes;
import com.example.sgnotes.notes.EditNotes;
import com.example.sgnotes.notes.NoteDetails;
...
import com.example.sgnotes.models.Notes;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        noteAdapter = new FirestoreRecyclerAdapter<Notes, NoteViewHolder>(allNotes) {
            ...
            @Override
            protected void onBindViewHolder(@NonNull NoteViewHolder noteViewHolder, final int i, @NonNull final Notes note) {
                    ...
                    public void onClick(final View v) {
                        ...
                        menu.getMenu().add("Edit").setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
                            ...
                            public boolean onMenuItemClick(MenuItem item) {
                                Intent i = new Intent(v.getContext(), EditNotes.class);
                                i.putExtra("title",note.getTitle());
                                i.putExtra("content",note.getContent());
                                i.putExtra("noteId",docId);
                                startActivity(i);
